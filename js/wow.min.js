        ...
        this.MozMutationObserver || (a = function() {
            ...
            function f(a) {
                null == a && (a = {}), this.scrollCallback = d(this.scrollCallback,
                    ...
                    0, this.config = this.util()
                    .extend(a, this.defaults),
            ...
            return f.prototype.defaults = {
                    ...
                    if (this.stopped = !1, this.boxes = function() {
                        var a, c, d, e;
                        for (d = this.element.getElementsByClassName(
                    ...
                    if (!this.stopped) {
                        if (null == a && (a = this.element), 1 !== a.nodeType)
                            return;
                        for (a = a.parentNode || a, f = a.getElementsByClassName(
                                this.config.boxClass), g = [], c = 0, d = f
                            .length; d > c; c++) b = f[c], e.call(this.all,
                            b) < 0 ? (this.applyStyle(b, !0), this.boxes
                            .push(b), this.all.push(b), g.push(this.scrolled = !
                                0)) : g.push(void 0);
                        return g
                    }
